...
import { ScoreGrade } from "@/components/ScoreGauge";
...
-3.5 w-3.5" /> Back to the index
        </Link>

        {/* Company header + top issues */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-3">
            <div className="bg-card border border-border border-t-2 border-t-deep-water p-6 md:p-8 shadow-subtle h-full">
