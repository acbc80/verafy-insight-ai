...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        display: ["64px", { lineHeight: "1.02", fontWeight: "600", letterSpacing: "-0.02em" }],
        h2: ["40px", { lineHeight: "1.1", fontWeight: "600", letterSpacing: "-0.02em" }],
        h3: ["24px", { lineHeight: "1.2", fontWeight: "600", letterSpacing: "-0.01em" }],
        row: ["20px", { lineHeight: "1.3", fontWeight: "500" }],
        body: ["17px", { lineHeight: "1.6", fontWeight: "400" }],
        sm: ["15px", { lineHeight: "1.55", fontWeight: "400" }],
